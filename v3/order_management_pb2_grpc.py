...
def add_OrderManagementServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOrderDetails': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__management__pb2.OrderIdRequest.FromString,
                    response_serializer=order__management__pb2.OrderDetailsResponse.SerializeToString,
            ),
            'GetOrderHistory': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=order__management__pb2.OrderHistoryResponse.SerializeToString,
            ),
    }
