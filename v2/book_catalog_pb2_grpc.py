...
class BookCatalogStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBookInfo = channel.unary_unary(
                '/protos.BookCatalog/GetBookInfo',
...
def add_BookCatalogServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.BookCatalog', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.BookCatalog', rpc_method_handlers)
