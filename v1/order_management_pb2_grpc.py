...
import protos.order_management_pb2 as order__management__pb2
...
class OrderManagementStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetOrderHistory = channel.unary_unary(
                ...
                request_serializer=order__management__pb2.UserID.SerializeToString,
...
def add_OrderManagementServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOrderHistory': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__management__pb2.UserID.FromString,
                    response_serializer=order__management__pb2.OrderHistory.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'bookstore.OrderManagement', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('bookstore.OrderManagement', rpc_method_handlers)
...
class OrderManagement(object):
    ...
    def GetOrderHistory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bookstore.OrderManagement/GetOrderHistory',
            order__management__pb2.UserID.SerializeToString,
